...
RUN apt-get install -y wget build-essential make g++  libboost-all-dev libssl-dev libdb++-dev libtool autotools-dev autoconf libboost-all-dev bsdmainutils pkg-config
